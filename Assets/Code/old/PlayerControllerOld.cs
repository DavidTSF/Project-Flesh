...
public class PlayerControllerOld : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        playerMovement.Player.Movement.performed += ctx => Move(ctx.ReadValue<Vector2>());
        playerMovement.Player.StartInteraction.performed += ctx => EnterInteractionMode();
        //playerMovement.Player.ChooseDirection.performed += ctx => ChooseDirection(ctx.ReadValue<Vector2>());
        playerMovement.Player.InteractDown.performed += ctx => TryInteractDown();
    }
